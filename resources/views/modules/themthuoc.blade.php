                            ...
                            <form method="post" action="" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="giasi" type="number" name="giasi" placeholder="Giá bán sĩ . . ." class="form-control" value="{{ old('giasi') }}">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="giale" type="mumber" name="giale" placeholder="Giá bán lẻ . . ." class="form-control" value="{{ old('giale') }}">
